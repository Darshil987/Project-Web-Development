...
if($conn){
    ...
    //register table
        ...
        if($regc == 0){
            $sql = "CREATE TABLE `register`(`srno` INT AUTO_INCREMENT PRIMARY KEY, `name` VARCHAR(22), `username` VARCHAR(20), `email` VARCHAR(20), `password` VARCHAR(20), `countrycode` INT(3), `mobile` BIGINT, `type` VARCHAR(20))";
